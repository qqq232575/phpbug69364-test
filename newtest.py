#!/usr/bin/env python
# coding:utf-8
# modify: by xin 09/17/2015
# python newtest.py -t "http://www.xxx.com/index.php" -x "100" -r "350000"
# NOTICE: IP_Port 需自寻大量代理IP放入数组
# WARNING：本工具仅限测试，禁用用于非法用途
...
def main():
    ...
    print "starting..."
    try:
        IP_Port = ["1.34.63.17:80","1.255.53.81:80","5.175.78.188:80"]
